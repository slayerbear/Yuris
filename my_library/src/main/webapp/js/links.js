var links = [{label: document.getElementById('link1'), bg: 'green'}, 
             {label: document.getElementById('link2'), bg: '#black'}, 
             {label: document.getElementById('link3'), bg: '#violet'}, 
             {label: document.getElementById('link4'), bg: '#blue'},
            {label: document.getElementById('link5'), bg: '#braun'}];
...
function styleCircle() {
  ...
  circle.style.width = radius*10+'px';
  circle.style.height = radius*10+'px';
...
function styleLinks() {
  for (var i=0, l=links.length; i<l; i++) {
    ...
    link.style.paddingLeft = radius*0.1+'px';
    ...
    setTransformOrigin(hover, '1px '+linkSize*0.5+'px');
...
function linkOver(e) {
  ...
  thisLink.style.paddingLeft = radius*1.45+'px';
...
function linkOut(e) {
  var thisLink = e.target, thisHover = thisLink.nextSibling;
  thisLink.style.paddingLeft = radius*0.2+'px';
  thisHover.style.opacity = 100;
}
